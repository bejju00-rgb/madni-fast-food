    ...
    <>
      ...
      >
        <div className="relative h-32 sm:h-48 overflow-hidden">
          ...
          >
            <Image
              src={item.image || "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400&h=400&fit=crop"}
              alt={item.name}
              fill
          ...
          >
            ...
            >
              <div className="relative h-64">
                <Image
                  src={item.image || "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=600&h=400&fit=crop"}
                  alt={item.name}
                  fill
                  className="object-cover"
                />
